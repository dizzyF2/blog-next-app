...
function MobileNavLinks() {
    ...
    return (
        <div className="capitalize flex flex-col justify-start mt-10 gap-4 text-sm ">
            <Link href={"/"}  className="pb-2 border-b-2 border-solid dark:border-b-[#2c2c2c]">Home</Link>
            <Link href={"/"}  className="pb-2 border-b-2 border-solid dark:border-b-[#2c2c2c]">Contents</Link>
